    ...
    return (
        <article className="rounded-2xl border border-neutral-800 bg-[#111111] p-4 sm:p-5">
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:gap-5 lg:justify-between">
                    ...
                    {[
                        {
                            ...
                            value: tournament.verifiedTeams,
                        },
                        {
                            label: "Pending Teams",
                            value: tournament.pendingTeams,
                        },
                        {
                            label: "Total Registration",
                            value: tournament.totalRegistration,
                        },
                    ].map((stat) => (
                        <div key={stat.label}>
                ...
                {hasActions ? (
                    <div
                        className={`grid gap-2 lg:flex lg:w-auto lg:flex-row lg:gap-2 lg:pl-6 ${
